  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-20">
      ...
      <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-5">
        <a
          href="#"
          className="py-3 px-5 sm:ms-4 text-sm font-medium text-primaryColor focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-secondaryColor focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
        >
          Contact Sales
        </a>
        <Link
          to="/create-account"
          className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primaryColor hover:bg-secondaryColor focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"
        >
          Get started
          <ArrowRight />
        </Link>
